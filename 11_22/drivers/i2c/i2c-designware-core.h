...
#define DW_ACK_GENERAL_CALL			0x98
...
#define DW_IC_COMP_PARAM_1_TX_DEPTH_SHIFT	16
#define DW_IC_COMP_PARAM_1_TX_DEPTH_MASK	\
	(0xff << DW_IC_COMP_PARAM_1_TX_DEPTH_SHIFT)

#define DW_IC_COMP_PARAM_1_RX_DEPTH_SHIFT	8
#define DW_IC_COMP_PARAM_1_RX_DEPTH_MASK	\
	(0xff << DW_IC_COMP_PARAM_1_RX_DEPTH_SHIFT)
...
#define IC_COMP_PARAM_1_HAS_DMA
#define IC_COMP_PARAM_1_HAS_DMA_SHIFT 6
#define IC_COMP_PARAM_1_HAS_DMA_MASK (1 << IC_COMP_PARAM_1_HAS_DMA_SHIFT)
...
struct dw_i2c_dev {
	struct device		*dev;
	void __iomem		*base;
	FRTOS_completion_t	cmd_complete;
	struct clk		*clk;
...
#define REG_READ_MASK(val, bit) (((val) & bit##_MASK) >> bit##_SHIFT)
...
//u32 buf_trans(u8 *buf, u32 i);
//void trans_buf(u8 *buf, u32 val, u32 regv_len);
//int i2c_transfer(void *dev, struct i2c_client *client,
