...
#define MUSB_TXFIFOSZ		0x1a	/* 8-bit (see masks) */
#define MUSB_RXFIFOSZ		0x1b	/* 8-bit (see masks) */
...
#define MUSB_FIFOSIZE		0x0A
#define MUSB_CONFIGDATA		0x0F	/* Re-used for EP0 */
